...
import os
from decouple import config, Csv  # Use decouple instead of dotenv for better Django integration
...
# For production, specify your actual domain instead of "*"
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    },
    {
        ...
        'OPTIONS': {
            'min_length': 9,  # Stronger password requirement
        }
    },
    {
